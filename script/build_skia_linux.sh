...
curl -T $ARCHIVE -u$BINTRAY_USER:$BINTRAY_KEY -H "X-Bintray-Package:Skia" -H "X-Bintray-Version:${VER}-linux" -H "X-Bintray-Publish:1" -H "X-Bintray-Override:1" https://api.bintray.com/content/jetbrains/skija/$ARCHIVE
