...
public class Library {
    ...
    static {
        try {
            ...
            case WINDOWS:
                _nativeLibraryClass = Class.forName("org.jetbrains.skija.platform.LibraryWidnows");
                break;
            case LINUX:
                _nativeLibraryClass = Class.forName("org.jetbrains.skija.platform.LibraryLinux");
                break;
            case MACOS_X64:
                _nativeLibraryClass = Class.forName("org.jetbrains.skija.platform.LibraryMacosX64");
                break;
            case MACOS_ARM64:
                _nativeLibraryClass = Class.forName("org.jetbrains.skija.platform.LibraryMacosArm64");
                break;
            }
    ...
    public static synchronized void load() {
        ...
        case WINDOWS:
            ...
            library = _extract("/", "skija.dll", tempDir);
            System.load(library.getAbsolutePath());
            break;
        case LINUX:
            library = _extract("/", "libskija.so", tempDir);
            System.load(library.getAbsolutePath());
            break;
        case MACOS_X64:
            library = _extract("/", "libskija_x64.dylib", tempDir);
            System.load(library.getAbsolutePath());
            break;
        case MACOS_ARM64:
            library = _extract("/", "libskija_arm64.dylib", tempDir);
            System.load(library.getAbsolutePath());
            break;
        }
