...
Skija is built against chrome/m83 release of Skia.

Prebuilt Skia can be downloaded from [JetBrains TeamCity CI](https://teamcity.jetbrains.com/buildConfiguration/JetBrainsPublicProjects_Skija_Skia).

Download, unpack and set

```
export SKIA_DIR=Downloads/Skija_Skia_macOS_6_artifacts
```
