...
public class TextLineTest implements Executable {
    ...
    public Font firaCode36 = new Font(Typeface.makeFromFile("src/test/resources/fonts/FiraCode-Regular.ttf"), 36);
    public Font jbMono36 = new Font(Typeface.makeFromFile("src/test/resources/fonts/JetBrainsMono-Regular.ttf"), 36);
