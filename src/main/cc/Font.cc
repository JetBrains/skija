...
extern "C" JNIEXPORT jlong JNICALL Java_skija_Font_nInit(JNIEnv* env, jclass jclass, jlong typefacePtr, jfloat size) {
...
extern "C" JNIEXPORT jlong JNICALL Java_skija_Font_nGetNativeFinalizer(JNIEnv* env, jclass jclass) {
