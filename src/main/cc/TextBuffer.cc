...
extern "C" JNIEXPORT jfloatArray JNICALL Java_skija_TextBuffer_nGetAdvances(JNIEnv* env, jclass jclass, jlong ptr) {
...
extern "C" JNIEXPORT jlong JNICALL Java_skija_TextBuffer_nGetNativeFinalizer(JNIEnv* env, jclass jclass) {
