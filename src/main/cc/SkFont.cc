...
extern "C" JNIEXPORT jlong JNICALL Java_org_jetbrains_skija_SkFont_nInit(JNIEnv* env, jclass jclass, jlong typefacePtr, jfloat size) {
...
extern "C" JNIEXPORT jlong JNICALL Java_org_jetbrains_skija_SkFont_nGetNativeFinalizer(JNIEnv* env, jclass jclass) {
    return static_cast<jlong>(reinterpret_cast<uintptr_t>(&deleteFont));
}

extern "C" JNIEXPORT jlong JNICALL Java_org_jetbrains_skija_SkFont_nShape(JNIEnv* env, jclass jclass, jlong ptr, jstring text, jfloat width) {
